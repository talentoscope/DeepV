...
Example:
  python -m dataset.run_processor --dataset floorplancad --input-dir ./data/raw/floorplancad --output-base ./data --dry-run
"""
import argparse
...
def main():
    ...
    parser.add_argument('--input-dir', type=Path, required=True, help='Raw dataset directory (e.g., data/raw/floorplancad)')
    parser.add_argument('--output-base', type=Path, default=Path('./data'), help='Base output dir for vector/raster folders')
