        ...
        try:
            ...
            for i, polygon in enumerate(polygons):
                ...
                if path_data:
                    ...
                    svg_elements.append(f'<path d="{path_data}" fill="{fill_color}" stroke="black" stroke-width="1" opacity="0.7"/>')
                    ...
                    if centroid:
                        ...
                        svg_elements.append(f'<text x="{cx}" y="{cy}" font-size="12" text-anchor="middle" fill="black">{label}</text>')
