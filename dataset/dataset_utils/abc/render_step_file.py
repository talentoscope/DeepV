...
from .utils.render_utils import export_shape_to_svg, read_step_file
...
def parse_args():
    ...
    parser.add_argument("-i", "--input-file", dest="input_file", required=True, help="input dir with ABC dataset.")
    parser.add_argument("-o", "--output-file", dest="output_file", required=True, help="output file.")
