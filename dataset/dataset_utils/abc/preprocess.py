...
from util_files.data.preprocessed import (
    _PreprocessedDataset,
    patch_parameters,
    svg_parameters,
)
...
def preprocess_beziers_only():
    ...
    for subset in "val", "train":
        data_root = (
            f"/data/abc_everything/testing_patches/{subset}"  # f'/data/svg_datasets/patched/abc/everything/{subset}'
        )
