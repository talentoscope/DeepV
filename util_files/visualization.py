...
def make_images(
    ...
    if with_skeleton:
        ...
        def renderer(lines):
            return render_without_skeleton(lines, patch_size=patch_size, primitive_type=pt)[..., None]
    ...
    if with_skeleton:
        ...
        def renderer(lines_out, lines_gt):
            return render_overlay_colored(lines_out, lines_gt, patch_size, primitive_type=pt)

    else:

        def renderer(lines_out, lines_gt):
            return render_overlay(lines_out, lines_gt, patch_size, primitive_type=pt)[..., None]
