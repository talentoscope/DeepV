...
empty_pixel_tolerance = (
    0  # max shading value for which the pixel is considered background in neighbourhood finding procedure
)
foreground_pixel_min_shading = 0.5  # min shading of pixel that is considered foreground in reinitialization procedure
...
qbezier_y_neighbourhood_padding = 0.1
neighbourhood_pos_weight = 2 * (1.0 / 0.5)
