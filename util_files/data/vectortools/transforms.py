...
def random_jitter(paths, translation_amplitude=0j, radius_amplitude=0, rotation_amplitude=0):
    ...
    transformed_points = {
        point: point
        + random.uniform(-translation_amplitude.real, translation_amplitude.real)
        + random.uniform(-translation_amplitude.imag, translation_amplitude.imag) * 1j
        for point in points
    }
    transformed_radii = {
        radius: radius.real * random.uniform(1 - radius_amplitude, 1 + radius_amplitude)
        + radius.imag * random.uniform(1 - radius_amplitude, 1 + radius_amplitude) * 1j
        for radius in radii
    }
