...
from .common import get_random_patch_from_svg, sample_primitive_representation
...
class PrecisionFloorplan(_SVGDataset):
    def __init__(
        ...
        *,
        ...
        random_width=True,
        rotate=True,
        per_path_translation_amplitude=8 + 8j,
        per_path_rotation_amplitude=10,
        jitter_translation_amplitude=8 + 8j,
        jitter_radius_amplitude=0.1,
        jitter_rotation_amplitude=10,
        mutually_exclusive_transforms=True,
        autoscale_transforms=True,
        **kwargs,
    ):
        ...
        super().__init__(
            ...
            rotate=rotate,
            per_path_translation_amplitude=per_path_translation_amplitude,
            per_path_rotation_amplitude=per_path_rotation_amplitude,
            jitter_translation_amplitude=jitter_translation_amplitude,
            jitter_radius_amplitude=jitter_radius_amplitude,
            jitter_rotation_amplitude=jitter_rotation_amplitude,
            mutually_exclusive_transforms=mutually_exclusive_transforms,
            autoscale_transforms=autoscale_transforms,
            **kwargs,
        )
        ...
        while True:
            while True:
                paths, attribute_dicts, _ = get_random_patch_from_svg(
                    ...
                    margin=self.margin,
                    new_ppi_to_old_ppi=self.ppi / 72,
                    scale_width=self.scale_width,
                    random_width=self.random_width,
                    rotate=self.rotate,
                    mutually_exclusive_transforms=self.mutually_exclusive_transforms,
                    per_path_translation_amplitude=self.per_path_translation_amplitude,
                    per_path_rotation_amplitude=self.per_path_rotation_amplitude,
                    jitter_translation_amplitude=self.jitter_translation_amplitude,
                    jitter_radius_amplitude=self.jitter_radius_amplitude,
                    remove_filled=True,
                )
            ...
            lines, arcs, beziers = sample_primitive_representation(
                paths,
                attribute_dicts,
                max_lines_n=self.max_primitives[PrimitiveType.PT_LINE],
                max_beziers_n=self.max_primitives[PrimitiveType.PT_BEZIER],
...
class SESYD(_SVGDataset):
    ...
    def __init__(
        ...
        *,
        ...
        random_width=True,
        rotate=True,
        per_path_translation_amplitude=16 + 16j,
        per_path_rotation_amplitude=10,
        jitter_translation_amplitude=16 + 16j,
        jitter_radius_amplitude=0.1,
        jitter_rotation_amplitude=10,
        mutually_exclusive_transforms=True,
        autoscale_transforms=True,
        outline_filled=True,
        outline_style={"stroke": "#000000", "stroke-width": "6.5"},
        **kwargs,
    ):
        ...
        while True:
            while True:
                paths, attribute_dicts, _ = get_random_patch_from_svg(
                    ...
                    jitter_radius_amplitude=self.jitter_radius_amplitude,
                    remove_filled=False,
                    outline_filled=self.outline_filled,
