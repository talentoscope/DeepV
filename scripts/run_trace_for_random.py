...
cmd = [sys.executable, 'run_pipeline.py', '--gpu', '0', '--data_dir', 'data/raster/floorplancad/test', '--image_name', choice, '--primitive_type', 'line', '--model_path', 'models/model_lines.weights', '--trace', '--trace_dir', './output/traces', '--output_dir', 'logs/outputs/vectorization/lines/']
